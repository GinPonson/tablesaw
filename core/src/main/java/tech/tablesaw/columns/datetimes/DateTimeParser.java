...
public class DateTimeParser extends AbstractParser<LocalDateTime> {
    ...
    private static final DateTimeFormatter dtTimef2 =
            new DateTimeFormatterBuilder().parseLenient().appendPattern("yyyy-MM-dd HH:mm:ss.S").toFormatter();  // 2014-07-09 13:03:44.7 (as above, but without leading 0 in millis
